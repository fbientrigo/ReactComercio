...
/* Aqui intente agregar metatags, lo dejare por si lo necesito
			<Helmet>
			<div itemscope itemType="http://schema.org/Product" data-react-helmet="true">
				<meta itemProp="brand" content="TodoCelular"/>
				<meta itemProp="name" content={product.name} data-react-helmet="true"/>
				<meta itemProp="description" content={product.description}/>
				<meta itemProp="productID" content={window.location.hash.split("/")[2]}/>
	...
	let schemaData = 			
		{
			...
			"productID":window.location.hash.split("/")[2],
